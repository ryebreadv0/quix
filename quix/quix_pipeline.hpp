...
inline consteval VkPipelineVertexInputStateCreateInfo create_vertex_state(
...
inline consteval VkPipelineDynamicStateCreateInfo create_dynamic_state(
...
inline consteval VkPipelineViewportStateCreateInfo create_viewport_state(
...
inline consteval VkPipelineColorBlendAttachmentState create_color_blend_attachment_state(
    ...
    const VkBlendOp alpha_blend_op, const VkColorComponentFlags color_write_mask = VK_COLOR_COMPONENT_R_BIT |
        VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT | VK_COLOR_COMPONENT_A_BIT)
{
    return VkPipelineColorBlendAttachmentState {
        .blendEnable = blend_enable,
...
inline consteval VkPipelineColorBlendStateCreateInfo create_color_blend_state(
...
inline consteval VkPipelineLayoutCreateInfo create_pipeline_layout_info(
    VkDescriptorSetLayout* set_layout, uint32_t set_layout_count,
    VkPushConstantRange* push_constant_range, uint32_t push_constant_count)
{
    return {
